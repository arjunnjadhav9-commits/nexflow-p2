...
.nx-mobile{display:none;flex-direction:column;position:fixed;top:56px;left:0;right:0;bottom:0;z-index:399;background:var(--surface,#161929);border-top:1px solid var(--border,#2a2d3e);padding:16px 20px 24px;overflow-y:auto}
